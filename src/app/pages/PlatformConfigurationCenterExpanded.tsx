/**
 * Platform Configuration Center - Expanded
 * 
 * Centralized control center for system administrators with additional configuration areas:
 * Templates, Admissions, Permissions Matrix, and Office Locations.
 */
...
import DocumentationTemplateManagement from '../components/configuration/DocumentationTemplateManagement';
import AdmissionConfigurationPanel from '../components/configuration/AdmissionConfigurationPanel';
import PermissionMatrixPanel from '../components/configuration/PermissionMatrixPanel';
import OfficeLocationPanel from '../components/configuration/OfficeLocationPanel';
...
export default function PlatformConfigurationCenterExpanded() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as ConfigTab)}>
          <TabsList className="grid grid-cols-12 w-full mb-6 text-xs">
          ...
          <TabsContent value="templates">
            <DocumentationTemplateManagement
              onConfigChange={() => setConfigState({ ...configState, hasUnsavedChanges: true })}
            />
          </TabsContent>

          <TabsContent value="admissions">
            <AdmissionConfigurationPanel
              onConfigChange={() => setConfigState({ ...configState, hasUnsavedChanges: true })}
            />
          </TabsContent>
